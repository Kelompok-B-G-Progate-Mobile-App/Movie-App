...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'CategorySearchResult'>;
...
const CategorySearch = (): JSX.Element => {
    ...
    const handleSearch = () => {
        if (selectedGenre) {
            navigation.navigate('CategorySearchResult', { genreId: selectedGenre.id });
        }
    };
